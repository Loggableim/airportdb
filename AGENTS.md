...
8. ✅ Custom Domain aktiv (world-airport-database.com, SSL via Google CA)
9. ✅ Daten-Import Script (CSV → Astro getStaticPaths Top 500)
10. ✅ 500 Airport-Profilseiten als Astro-Routes (501 Seiten)
11. ✅ Länder-Seiten (238 Länder unter /countries/[slug]/ mit Stats/Map/Table)
12. ✅ Nearest Airport Finder (/tools/nearest-airport/, Haversine vs 9.056 Airports)
13. ✅ SEO (Sitemap, OG-Tags, JSON-LD Airport/WebSite/Breadcrumb, Canonical, robots.txt)
14. ✅ Content-Cron (3x täglich 06/14/22 Uhr, rotiert Top10/IATA Guide/Spotlight)
